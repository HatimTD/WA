  ...
  try {
    ...
    const cases = await prisma.waCaseStudy.findMany({
      ...
      select: {
        ...
        expectedServiceLifeHours: true,
        expectedServiceLifeDays: true,
        expectedServiceLifeWeeks: true,
        expectedServiceLifeMonths: true,
        expectedServiceLifeYears: true,
        previousServiceLife: true,
        previousServiceLifeHours: true,
        previousServiceLifeDays: true,
        previousServiceLifeWeeks: true,
        previousServiceLifeMonths: true,
        previousServiceLifeYears: true,
