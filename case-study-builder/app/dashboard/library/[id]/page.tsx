...
export default async function PublicCaseDetailPage({
  ...
  const pdfData: CaseStudyPDFData = {
    ...
    wps: caseStudy.wps ? {
      numberOfLayers: caseStudy.wps.numberOfLayers || undefined,
      process: caseStudy.wps.weldingProcess || undefined,
      technique: caseStudy.wps.technique || undefined,
      weldingPosition: caseStudy.wps.weldingPosition || undefined,
      torchPosition: caseStudy.wps.torchPosition || undefined,
      voltage: caseStudy.wps.voltage || undefined,
      amperage: caseStudy.wps.intensity || undefined,
      wireSpeed: caseStudy.wps.wireSpeed || undefined,
      weavingWidth: caseStudy.wps.weavingWidth || undefined,
      oscillation: caseStudy.wps.oscillation || undefined,
      ...
      gasFlowRate: caseStudy.wps.gasFlowRate || undefined,
      preheatTemp: caseStudy.wps.preheatTemp || undefined,
      interpassTemp: caseStudy.wps.interpassTemp || undefined,
      postWeldTreatment: caseStudy.wps.postWeldTreatment || undefined,
    } : undefined,
  };
