  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <Card className="bg-blue-50 border-blue-200">
        <CardHeader>
          <CardTitle className="text-blue-900">About Voice Input Network Errors</CardTitle>
        </CardHeader>
        <CardContent className="text-sm space-y-3">
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-1 ml-4">
              <li><strong>Wrong URL:</strong> Must use <code className="bg-blue-100 px-1 rounded">http://localhost:3010</code> (NOT network IP address)</li>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-1 ml-4">
              <li>Ensure you're accessing <code className="bg-blue-100 px-1 rounded">http://localhost:3010</code></li>
          ...
          <div className="bg-blue-50 border border-blue-200 p-3 rounded mt-3">
            <p className="font-semibold text-blue-800 mb-2">🦁 Brave Browser Fix (Recommended):</p>
